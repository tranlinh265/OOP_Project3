...
//        data.doInsertInToDB();
    ...
    public void doInsertInToDB(){
        ...
        doInsertInToTableSP(1, "SONY 43W800C");              doInsertInToTableMT(1, "Smart Tivi, 3D, 43 inch\n" +
                "Độ phân giải: Full HD\n" +
                "Kết nối: HDMI, USB, Wifi\n" +
                "Tần số quét MXR: 800 Hz", "Tốt");
        doInsertInToTableSP(2, "SONY 32R300C");              doInsertInToTableMT(2, "Tivi LED, 32 inch\n" +
                "Độ phân giải: HD Ready\n" +
                "Kết nối: HDMI, USB\n" +
                "Tần số quét MXR: 100 Hz", "Tốt");
        doInsertInToTableSP(3, "SONY 48W700C");              doInsertInToTableMT(3, "Internet Tivi, 48 inch\n" +
                "Độ phân giải: Full HD\n" +
                "Kết nối: HDMI, USB, Wifi\n" +
                "Tần số quét MXR: 200 Hz", "Mới");
        doInsertInToTableSP(4, "SAMSUNG 43J5500");           doInsertInToTableMT(4, "Smart Tivi, 43 inch\n" +
                "Độ phân giải: Full HD\n" +
                "Kết nối: HDMI, USB, Wifi\n" +
                "Tần số quét CMR: 100 Hz", "Khá Mới");
        doInsertInToTableSP(5, "SAMSUNG 32J4100");           doInsertInToTableMT(5, "Tivi LED, 32 inch\n" +
                "Độ phân giải: HD Ready\n" +
                "Kết nối: HDMI, USB\n" +
                "Tần số quét CMR: 100 Hz", "Cũ");
        doInsertInToTableSP(6, "SAMSUNG 40J5500");           doInsertInToTableMT(6, "Smart Tivi, 40 inch\n" +
                "Độ phân giải: Full HD\n" +
                "Kết nối: HDMI, USB, Wifi\n" +
                "Tần số quét CMR: 100 Hz", "Khá Mới");
        doInsertInToTableSP(7, "SAMSUNG 48J5500");           doInsertInToTableMT(7, "Smart Tivi, 48 inch\n" +
                "Độ phân giải: Full HD\n" +
                "Kết nối: HDMI, USB, Wifi\n" +
                "Tần số quét CMR: 100 Hz", "Mới");
        doInsertInToTableSP(8, "SONY 43X8300C");             doInsertInToTableMT(8, "Tivi 4K Smart, 43 inch\n" +
                "Độ phân giải: Ultra 4K HD\n" +
                "Kết nối: HDMI, USB, Wifi\n" +
                "Tần số quét MXR: 800 Hz", "Tốt");
        doInsertInToTableSP(9, "LG 32LF550D");               doInsertInToTableMT(9, "Tivi LED, 32 inch\n" +
                "Độ phân giải: HD Ready\n" +
                "Kết nối: HDMI, USB\n" +
                "Tần số quét: TruMotion 50 Hz", "Khá Tốt");    doInsertInToTableTT(9, 9, 1, 3, 5600000, "32");
        doInsertInToTableSP(10, "LG 49LF540T");              doInsertInToTableMT(10, "Tivi LED, 49 inch\n" +
                "Độ phân giải: Full HD\n" +
                "Kết nối: HDMI, USB\n" +
                "Tần số quét: TruMotion 50 Hz", "Khá Tốt");   doInsertInToTableTT(10, 10, 1, 3, 12600000, "49");

        doInsertInToTableSP(11, "TOSIBA S19VPP(S)");         doInsertInToTableMT(11, "Tủ lạnh ngăn đá trên\n" +
                "Dung tích 171 lít\n" +
                "Làm lạnh vòng cung\n" +
                "Khử mùi và Diệt khuẩn Hybrid Bio", "Tốt");       doInsertInToTableTT(11, 11, 2, 4, 5590000, "S");
        doInsertInToTableSP(12, "TOSIBA S19VPP(DS)");        doInsertInToTableMT(12, "Tủ lạnh ngăn đá trên\n" +
                "Dung tích 171 lít\n" +
                "Làm lạnh vòng cung\n" +
                "Khử mùi và Diệt khuẩn Hybrid Bio", "Mới");       doInsertInToTableTT(12, 12, 2, 4, 5790000, "XS");
        doInsertInToTableSP(13, "SAMSUNG RT43H5231SL/SV");   doInsertInToTableMT(13, "Tủ lạnh ngăn đá trên\n" +
                "Dung tích 442 lít\n" +
                "Làm lạnh đa chiều\n" +
                "Công nghệ Inverter, khử mùi Deodorizer", "Khá Mới");   doInsertInToTableTT(13, 13, 2, 2, 6000000, "M");
        doInsertInToTableSP(14, "SAMSUNG RT50H6631SL/SV");   doInsertInToTableMT(14, "Tủ lạnh ngăn đá trên\n" +
                "Dung tích 507 lít\n" +
                "Làm lạnh đa chiều\n" +
                "Công nghệ Inverter, khử mùi Deodorizer", "Khá Mới");   doInsertInToTableTT(14, 14, 2, 2, 7000000, "M");
        doInsertInToTableSP(15, "ELECTROLUX ETB2302PE");     doInsertInToTableMT(15, "Tủ lạnh ngăn đá trên\n" +
                "Dung tích 230 lít\n" +
                "Làm lạnh đa chiều\n" +
                "Khử mùi Deo Fresh", "Khá Tốt");   doInsertInToTableTT(15, 15, 2, 5, 5000000, "XXL");
        doInsertInToTableSP(16, "ELECTROLUX EME2600SA-RVN"); doInsertInToTableMT(16, "Tủ lạnh ngăn đá trên\n" +
                "Dung tích sử dụng: 260 lít\n" +
                "Làm lạnh đa chiều\n" +
                "Lọc mùi kép Deo Fresh", "Mới");       doInsertInToTableTT(16, 16, 2, 5, 8000000, "XXXL");
        doInsertInToTableSP(17, "HITACHI V400PGV3");         doInsertInToTableMT(17, "Tủ lạnh ngăn đá trên\n" +
                "Dung tích 335 lít\n" +
                "Làm lạnh gián tiếp\n" +
                "Kháng khuẩn, khử mùi : Nano Titanium", "Cũ");        doInsertInToTableTT(17, 17, 2, 6, 6341240, "M");
        doInsertInToTableSP(18, "SAMSUNG RT38FEAKDSL/SV");   doInsertInToTableMT(18, "Tủ lạnh ngăn đá trên\n" +
                "Dung tích 380 lít\n" +
                "Làm lạnh đa chiều\n" +
                "Công nghệ Inverter, khử mùi Silver Nano", "Cũ");        doInsertInToTableTT(18, 18, 2, 2, 10000000, "XXXL");
        doInsertInToTableSP(19, "HITACHI VG470PGV3");        doInsertInToTableMT(19, "Tủ lạnh ngăn đá trên\n" +
                "Dung tích 395 lít\n" +
                "Làm lạnh gián tiếp\n" +
                "Công nghệ Inverter, Nano Titanium", "Mới");       doInsertInToTableTT(19, 19, 2, 6, 4900000, "M");
        doInsertInToTableSP(20, "SANYO SR-PQ285RB/SB");      doInsertInToTableMT(20, "Tủ lạnh ngăn đá dưới\n" +
                "Dung tích 284 lít\n" +
                "Làm lạnh đa chiều\n" +
                "Diệt khuẩn và khử mùi Nano Fresh Ag+", "Khá Mới");   doInsertInToTableTT(20, 20, 2, 7, 6000000, "S");
        doInsertInToTableSP(21, "SANYO SR-Q345RB/SS");       doInsertInToTableMT(21, "Tủ lạnh ngăn đá dưới\n" +
                "Dung tích 335 lít\n" +
                "Làm lạnh đa chiều\n" +
                "Khử mùi kháng khuẩn Nano Ag+", "Mới");       doInsertInToTableTT(21, 21, 2, 7, 7000000, "XS");
        doInsertInToTableSP(22, "ELECTROLUX EBE3500SA");     doInsertInToTableMT(22, "Tủ lạnh ngăn đá trên\n" +
                "Dung tích 210 lít\n" +
                "Làm lạnh đa chiều\n" +
                "Khử mùi Deo Fresh", "Cũ");        doInsertInToTableTT(22, 22, 2, 5, 8000000, "XXS");

        doInsertInToTableSP(23, "SAMSUNG WW75J3283GS/SV");   doInsertInToTableMT(23, "Máy giặt lồng ngang, 7.5kg\n" +
                "Truyền động bằng dây Curoa\n" +
                "Tốc độ quay vắt: 1200 vòng/phút\n" +
                "Lồng giặt kim cương", "Mới");       doInsertInToTableTT(23, 23, 3, 2, 4000000, "S");
        doInsertInToTableSP(24, "ELECTROLUX EWF85742");      doInsertInToTableMT(24, "Máy giặt lồng ngang, 7.5kg\n" +
                "Truyền động bằng dây Curoa\n" +
                "Tốc độ quay vắt: 850 vòng/phút\n" +
                "14 chương trình giặt", "Cũ");        doInsertInToTableTT(24, 24, 3, 5, 6020300, "M");
        doInsertInToTableSP(25, "TOSIBA E920LV(WL)");        doInsertInToTableMT(25, "Máy giặt lồng đứng, 8,2 kg\n" +
                "Truyền động trực tiếp\n" +
                "Tốc độ quay vắt: 700 vòng/phút\n" +
                "Mâm giặt xoay đảo chiều", "Khá Tốt");   doInsertInToTableTT(25, 25, 3, 4, 5000000, "XS");

        doInsertInToTableSP(26, "DAIKIN FTNE35MV1V");        doInsertInToTableMT(26, "Công suất: 12000 BTU\n" +
                "Điều hòa thường\n" +
                "Phạm vi làm lạnh: 20m2\n" +
                "Gas: R410A", "Tốt");       doInsertInToTableTT(26, 26, 4, 8, 4900000, "M");
        doInsertInToTableSP(27, "DAIKIN FTXM25HVMV");        doInsertInToTableMT(27, "Công suất: 9000 BTU\n" +
                "Điều hòa thường\n" +
                "Phạm vi làm lạnh: 15m2\n" +
                "Gas: R410A", "Khá Tốt");   doInsertInToTableTT(27, 27, 4, 8, 8090000, "S");
        doInsertInToTableSP(28,"PANASONIC CU/CS-KC12QKH-8");doInsertInToTableMT(28, "Công suất: 9000 BTU\n" +
                "Điều hòa thường\n" +
                "Phạm vi làm lạnh: 15m2\n" +
                "Gas: R22", "Cũ");        doInsertInToTableTT(28, 28, 4, 9, 6000000, "M");
        doInsertInToTableSP(29, "DAIKIN FTXM35HVMV");        doInsertInToTableMT(29, "Công suất: 9000 BTU\n" +
                "Điều hòa inverter\n" +
                "Phạm vi làm lạnh: 15m2\n" +
                "Gas: R32", "Tốt");       doInsertInToTableTT(29, 29, 4, 8, 6789283, "S");

        doInsertInToTableSP(30, "SAMSUNG HT-E350K");         doInsertInToTableMT(30, "Hệ thống loa: 5.1 kênh\n" +
                "Công suất: 330W\n" +
                "Âm thanh: Dolby Digital\n" +
                "Kết nối: HDMI, USB", "Mới");       doInsertInToTableTT(30, 30, 5, 2, 7277738, "XS");
        doInsertInToTableSP(31, "SONY BDV-E6100");           doInsertInToTableMT(31, "Hệ thống loa: 5.1 kênh\n" +
                "Công suất: 1000W\n" +
                "Âm thanh: Dolby Digital\n" +
                "Kết nối: HDMI, USB, Wifi, NFC, Bluetooth", "Khá Mới");   doInsertInToTableTT(31, 31, 5, 1, 3092992, "L");
        doInsertInToTableSP(32, "SONY DAV-TZ150");           doInsertInToTableMT(32, "Hệ thống loa: 5.1 kênh\n" +
                "Công suất: 300W\n" +
                "Âm thanh: Dolby Digital\n" +
                "Kết nối: HDMI, USB", "Khá Mới");   doInsertInToTableTT(32, 32, 5, 1, 3929900, "XXL");
        doInsertInToTableSP(33, "SAMSUNG HT-F453HRK");       doInsertInToTableMT(33, "Hệ thống loa: 5.1 kênh\n" +
                "Công suất: 1000W\n" +
                "Âm thanh: Dolby Digital\n" +
                "Kết nối: HDMI, USB, Bluetooth", "Mới");       doInsertInToTableTT(33, 33, 5, 2, 8829391, "XXXL");
        doInsertInToTableSP(34, "SAMSUNG BDV-E2100");        doInsertInToTableMT(34, "Hệ thống loa: 5.1 kênh\n" +
                "Công suất: 1000W\n" +
                "Âm thanh: Dolby Digital\n" +
                "Kết nối: HDMI, USB, Wifi, Bluetooth", "Tốt");       doInsertInToTableTT(34, 34, 5, 2, 3129312, "XXL");

        doInsertInToTableSP(35, "LENOVO H3000ST");           doInsertInToTableMT(35, "CPU: Intel Pentium, 2.4Ghz\n" +
                "RAM: 2GB/ HDD: 500GB\n" +
                "VGA: Intel HD Graphics\n" +
                "Ổ quang: DVDRW\n" +
                "HĐH: Windows 8.1", "Tốt");       doInsertInToTableTT(35, 35, 6, 10, 8000000, "XXS");
        doInsertInToTableSP(36, "HP 110-500x");              doInsertInToTableMT(36, "CPU: Intel Pentium, 2.4Ghz\n" +
                "RAM: 2GB/ HDD: 500GB\n" +
                "VGA: Intel HD Graphics\n" +
                "Ổ quang: DVDRW\n" +
                "HĐH: Free DOS", "Mới");       doInsertInToTableTT(36, 36, 6, 11, 10000000, "L");
        doInsertInToTableSP(37, "HP 251-a20L");              doInsertInToTableMT(37, "CPU: Intel Celeron, 1.6Ghz\n" +
                "RAM: 2GB/ HDD: 500GB\n" +
                "VGA: Intel HD Graphics\n" +
                "Ổ quang: DVDRW\n" +
                "HĐH: Free DOS", "Khá Mới");   doInsertInToTableTT(37, 37, 6, 11, 11000000, "XS");
        doInsertInToTableSP(38, "ACER XOESV 007");           doInsertInToTableMT(38, "CPU: Intel Celeron, 1.6Ghz\n" +
                "RAM: 2GB/ HDD: 500GB\n" +
                "VGA: Intel HD Graphics\n" +
                "Ổ quang: DVDRW\n" +
                "HĐH: Free DOS", "Cũ");        doInsertInToTableTT(38, 38, 6, 12, 5000000, "S");
        doInsertInToTableSP(39, "ACER XoESV 009");           doInsertInToTableMT(39, "CPU: Intel Pentium, 1.6Ghz\n" +
                "RAM: 2GB/ HDD: 500GB\n" +
                "VGA: Intel HD Graphics\n" +
                "Ổ quang: DVDRW\n" +
                "HĐH: Free DOS", "Mới");       doInsertInToTableTT(39, 39, 6, 12, 6000000, "S");

        doInsertInToTableSP(40, "SAMSUNG G935FD");           doInsertInToTableMT(40, "Màn hình: 5.1 inch, QuadHD\n" +
                "HĐH: Android 6.0\n" +
                "CPU: 8 nhân 2.3Ghz, RAM: 4GB\n" +
                "Camera: 12MP, 1 SIM, 4G\n" +
                "Pin: 3600mAh", "Tốt");       doInsertInToTableTT(40, 40, 7, 2, 5000000, "32");
        doInsertInToTableSP(41, "OPPO F1");                  doInsertInToTableMT(41, "Màn hình: 5 inch, HD\n" +
                "HĐH: Android 5.1\n" +
                "CPU: 8 nhân 1.7Ghz, RAM: 3GB\n" +
                "Camera: 13MP, 2 SIM\n" +
                "Pin: 2500mAh", "Cũ");        doInsertInToTableTT(41, 41, 7, 13, 4000000, "40");
        doInsertInToTableSP(42, "OPPO A33w");                doInsertInToTableMT(42, "Màn hình: 5 inch, qHD\n" +
                "HĐH: Android 5.1\n" +
                "CPU: 4 nhân 1.3Ghz, RAM: 1GB\n" +
                "Camera: 8MP, 2 SIM\n" +
                "Pin: 2420mAh", "Khá Mới");   doInsertInToTableTT(42, 42, 7, 13, 3500000, "20");
        doInsertInToTableSP(43, "OPPO 1201");                doInsertInToTableMT(43, "Màn hình: 4.5 inch, WVGA\n" +
                "HĐH: Android 4.4\n" +
                "CPU: 4 nhân 1.3Ghz, RAM: 1GB\n" +
                "Camera: 8MP, 2 SIM, 3G\n" +
                "Pin: 2000mAh", "Khá Tốt");   doInsertInToTableTT(43, 43, 7, 13, 5000000, "21");
        doInsertInToTableSP(44, "SONY Xperia E2353");        doInsertInToTableMT(44, "Màn hình: 5 inch, HD\n" +
                "HĐH: Android 5.0\n" +
                "CPU: 8 nhân 1.7Ghz, RAM: 2GB\n" +
                "Camera: 13MP, 1 SIM, 4G\n" +
                "Pin: 2400mAh", "Mới");       doInsertInToTableTT(44, 44, 7, 1, 8000400, "50");
        doInsertInToTableSP(45, "APPLE IPHONE S5");         doInsertInToTableMT(45, "Màn hình: 4 inch, DVGA\n" +
                "HĐH: iOS 9\n" +
                "CPU: Apple A7, RAM: 1GB\n" +
                "Camera: 8MP, 1 SIM, 4G\n" +
                "Pin: 1560mAh", "Tốt");       doInsertInToTableTT(45, 45, 7, 14, 20000000, "62");
